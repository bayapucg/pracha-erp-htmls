		...
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
				...
				<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                           <div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
                              <div class="project-info clearfix">
                                 ...
                                 <div class="project-info-right">
                                    <span class="no text-blue weight-500 font-24">Pracha Regional Rating</span>
                                 </div>
                              </div>
                              <div class="project-info-progress">
                                 <div class="row clearfix">
			...
			<div class="row clearfix">
				<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-30" style="height:350px;overflow-y: scroll;">
					...
					<div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 mb-30">
					<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
						...
						<div class="pd-20 bg-white border-radius-4 box-shadow">
							...
							<ul class="list-group font-12">
								...
								<li class="list-group-item d-flex justify-content-between align-items-center">
									...
									<span class="badge badge-primary badge-pill">Tomorrow</span>
								</li>
								<li class="list-group-item d-flex justify-content-between align-items-center">
									Morbi leo risus
									<span class="badge badge-primary badge-pill">Aug-1</span>
								</li>
								<li class="list-group-item d-flex justify-content-between align-items-center">
									Dapibus ac facilisis in
									<span class="badge badge-primary badge-pill">Aug-10</span>
								</li>
								<li class="list-group-item d-flex justify-content-between align-items-center">
									Morbi leo risus
									<span class="badge badge-primary badge-pill">Sept-5</span>
								</li>
