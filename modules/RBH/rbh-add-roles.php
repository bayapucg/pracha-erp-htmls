		...
		<div class="pd-ltr-20 blog-detail mx-3 py-4">
			 <form id="defaultForm" method="post" action="form-validation.php">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <label class=""><b>Add Department</b></label>
                            ...
                            <div class="">
						       ...
						       <div class="form-group col-md-6">
                            <label class=""><b>Add Designation</b></label>
                            <div class="">
                                <select class="browser-default custom-select">
								  <option selected>Select Designation</option>
								  <option value="1">Director</option>
								  <option value="2">RBH</option>
								  <option value="3">HR</option>
								</select>
                            </div>
                        </div>
						<div class="form-group col-md-6">
                            <label class=""><b>Add Level</b></label>
                            <div class="">
                                <select class="browser-default custom-select">
						...
						<div class="form-group col-md-6">
                            <label class=""><b>Add Roles and Responsibilities</b></label>
                            <div class="">
